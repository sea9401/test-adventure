...
- [ ] **Step 1: Write failing speed-taper and stat-overlay tests**
...
- [ ] **Step 3: Implement bounded speed interpolation and the stat overlay**
...
- [ ] **Step 3: Apply the overlay once at the generator boundary**
...
- [ ] **Step 4: Run focused generator and balance tests and verify GREEN**
...
- [ ] **Step 5: Commit generated high-difficulty monsters**
...
- [ ] **Step 1: Inspect the CLI loop contract**
...
- [ ] **Step 1: Run the anonymous live snapshot once**
...
- [ ] **Step 2: Evaluate the exact target bands**
...
- [ ] **Step 3: Apply one bounded curve correction only if an exact band fails**
...
- [ ] **Step 5: Commit evidence-driven calibration if changed**
