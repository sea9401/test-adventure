...
- [x] **Step 1: Write the failing repeat-mount and nonblocking-panel tests**
...
- [x] **Step 3: Implement the minimal session gate and panel**
...
- [x] **Step 4: Prevent pre-hydration refresh flashes**
...
- [x] **Step 5: Update the accessibility journey**
