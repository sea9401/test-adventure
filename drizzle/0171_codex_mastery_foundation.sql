...
CREATE INDEX "codex_mastery_summary_total_score_rank_idx" ON "codex_mastery_summary" USING btree ("total_score_milli" DESC NULLS LAST,"score_reached_at","user_id");--> statement-breakpoint
CREATE INDEX "codex_mastery_summary_equipment_score_rank_idx" ON "codex_mastery_summary" USING btree ("equipment_score_milli" DESC NULLS LAST,"score_reached_at","user_id");--> statement-breakpoint
CREATE INDEX "codex_mastery_summary_fish_score_rank_idx" ON "codex_mastery_summary" USING btree ("fish_score_milli" DESC NULLS LAST,"score_reached_at","user_id");--> statement-breakpoint
CREATE INDEX "codex_mastery_summary_monster_score_rank_idx" ON "codex_mastery_summary" USING btree ("monster_score_milli" DESC NULLS LAST,"score_reached_at","user_id");--> statement-breakpoint
CREATE INDEX "codex_mastery_summary_cooking_score_rank_idx" ON "codex_mastery_summary" USING btree ("cooking_score_milli" DESC NULLS LAST,"score_reached_at","user_id");--> statement-breakpoint
CREATE INDEX "codex_mastery_summary_life_score_rank_idx" ON "codex_mastery_summary" USING btree ("life_score_milli" DESC NULLS LAST,"score_reached_at","user_id");--> statement-breakpoint
CREATE INDEX "codex_mastery_summary_job_score_rank_idx" ON "codex_mastery_summary" USING btree ("job_score_milli" DESC NULLS LAST,"score_reached_at","user_id");