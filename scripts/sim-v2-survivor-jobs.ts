// 생존자 루트 스팟 sim.
// 실행: node --import tsx scripts/sim-v2-survivor-jobs.ts
...
const CASES: Case[] = [
  {
    ...
    level: LEVEL,
    classTier: 1,
    alloc: alloc(LEVEL, { str: 0.25, vit: 0.25, dex: 0.25, int: 0.25 }),
    skills: V2_SKILLS_BY_JOB.none,
  },
  {
    jobId: "squire",
    label: "견습기사",
    ...
    skills: [...V2_SKILLS_BY_JOB.squire, ...V2_SKILLS_BY_JOB.warrior],
  },
  {
    jobId: "guardian",
    label: "가디언",
    ...
    level: LEVEL,
    classTier: 3,
    alloc: alloc(LEVEL, { vit: 0.55, str: 0.25, spi: 0.2 }),
    skills: [...V2_SKILLS_BY_JOB.guardian, ...V2_SKILLS_BY_JOB.shieldman, ...V2_SKILLS_BY_JOB.warrior],
  },
  {
    jobId: "warmonk",
    label: "무승",
    ...
    classTier: 3,
    alloc: alloc(LEVEL, { vit: 0.55, str: 0.25, spi: 0.2 }),
    skills: [...V2_SKILLS_BY_JOB.warmonk, ...V2_SKILLS_BY_JOB.monk, ...V2_SKILLS_BY_JOB.martial],
  },
  {
    jobId: "bishop",
    label: "대사제",
    ...
    skills: [...V2_SKILLS_BY_JOB.bishop, ...V2_SKILLS_BY_JOB.acolyte, ...V2_SKILLS_BY_JOB.mage],
  },
  {
    jobId: "survivor",
    label: "생존자",
    ...
    level: LEVEL,
    classTier: 1,
    alloc: alloc(LEVEL, { vit: 0.5, spi: 0.25, str: 0.25 }),
    skills: V2_SKILLS_BY_JOB.survivor,
  },
  {
    jobId: "camper",
    label: "야영꾼",
    ...
    level: LEVEL,
    classTier: 2,
    alloc: alloc(LEVEL, { vit: 0.45, spi: 0.35, str: 0.2 }),
    skills: [...V2_SKILLS_BY_JOB.camper, ...V2_SKILLS_BY_JOB.survivor],
  },
  {
    jobId: "ironman",
    label: "철인",
    ...
    level: LEVEL,
    classTier: 2,
    alloc: alloc(LEVEL, { vit: 0.6, str: 0.25, spi: 0.15 }),
    skills: [...V2_SKILLS_BY_JOB.ironman, ...V2_SKILLS_BY_JOB.survivor],
  },
  {
    jobId: "fieldmedic",
    label: "의무병",
    ...
    level: LEVEL,
    classTier: 3,
    alloc: alloc(LEVEL, { vit: 0.45, spi: 0.35, int: 0.2 }),
    skills: [...V2_SKILLS_BY_JOB.fieldmedic, ...V2_SKILLS_BY_JOB.camper, ...V2_SKILLS_BY_JOB.survivor],
  },
  {
    jobId: "rescueexpert",
    label: "구조전문",
    ...
    alloc: alloc(LEVEL, { vit: 0.45, spi: 0.35, int: 0.2 }),
    skills: [
      ...V2_SKILLS_BY_JOB.rescueexpert,
      ...V2_SKILLS_BY_JOB.fieldmedic,
      ...V2_SKILLS_BY_JOB.camper,
      ...V2_SKILLS_BY_JOB.survivor,
    ],
  },
  {
    jobId: "extremesurvivor",
    label: "극한생존",
    classId: "survivor",
    level: LEVEL,
    classTier: 3,
    alloc: alloc(LEVEL, { vit: 0.55, str: 0.3, luk: 0.15 }),
    skills: [...V2_SKILLS_BY_JOB.extremesurvivor, ...V2_SKILLS_BY_JOB.ironman, ...V2_SKILLS_BY_JOB.survivor],
  },
  {
    jobId: "returner",
    label: "생환자",
    ...
    level: LEVEL,
    classTier: 4,
    alloc: alloc(LEVEL, { vit: 0.6, str: 0.25, luk: 0.15 }),
    skills: [
      ...V2_SKILLS_BY_JOB.returner,
      ...V2_SKILLS_BY_JOB.extremesurvivor,
      ...V2_SKILLS_BY_JOB.ironman,
      ...V2_SKILLS_BY_JOB.survivor,
    ],
  },
];
...
console.log(
  `생존자 루트 sim — Lv${LEVEL}, 무장비, TRIALS=${TRIALS_PER_MONSTER}/monster, depth=${DEPTHS.join(",")}`,
);
