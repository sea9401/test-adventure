  ...
  return (
    <Card as="section" padding="lg">
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 rounded-md border border-amber-300 bg-amber-50 px-3 py-2 dark:border-amber-900 dark:bg-zinc-950">
          <Coins
            size={16}
            weight="fill"
        ...
        <div className="space-y-2">
          {STAT_KEYS.map((k) => {
            ...
            return (
              <div
                key={k}
                className={`flex items-center gap-3 rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 dark:border-zinc-800 dark:bg-zinc-900 ${ringCls}`}
              >
                <Icon
                  size={22}
                  weight="duotone"
