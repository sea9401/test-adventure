...
// 별빛 강화는 만렙 전용. *시도* 비용(실패해도 차감).
// RDS 실측(2026-05-22, 만렙 median 82k·최고 149k)에 맞춰 하향 — 원안(총 158.5k/자루)은
// 전 유저가 풀강 한 자루도 못 하는 과대책정이었다. 풀강(+7) 누적 = 39,550G/무기,
// 풀세트(3종) ~118,650G(만렙 자산으로 모아서 도달하는 목표). 실측 후 재튜닝.
export const ENHANCE_GOLD_COST: readonly number[] = [
  0, 250, 600, 1200, 2500, 5000, 10000, 20000,
];
