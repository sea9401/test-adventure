...
export const STARLIT_QUESTS: Quest[] = [
  ...
  // 보상: 4단으로 corridor 5종 + road 5종 제작서 전부 풀린다 (5단 craft chain 의 중간 출처).
  {
    ...
    title: "회랑의 흩어진 별빛",
    description:
      "별바다 노수호자 유성의 첫 부탁. 회랑에 떠도는 시녀들의 잔영이 별빛 길을 흐트러뜨리고 있다. 열둘만 가라앉히면 회랑검과 회랑 방패 벼림법을 넘겨준다.",
    requiredLevel: 75,
  ...
  },
  {
    ...
    title: "망령을 풀어내라",
    description:
      "회랑 깊은 곳에 별빛 망령들이 옛 별길을 붙들고 있다. 열다섯만 풀어주면 회랑창과 회랑 너클 벼림법을 함께 넘겨준다.",
    requiredLevel: 76,
  ...
  // 회랑 골렘(Q3) 완수 후 노출 / 완료 시 storyFlag `skyfolk_gate_cleared` 셋.
  {
    ...
    title: "폐도의 봉인을 풀어라",
    description:
      "폐도 안쪽 깊이 잘못 굳어 있는 봉인을 더는 둘 수 없다. 천공인 사관의 잔재 열만 정리하면 천공인의 왕이 비로소 자네를 마주할 것이다.",
    requiredLevel: 80,
  ...
  // 황성 호위병(Q4 throne-guards) 완수 후 노출 / 완료 시 storyFlag `apex_gate_cleared` 셋.
  {
    ...
    title: "옥좌의 봉인을 풀어라",
    description:
      "옥좌 둘레에 별빛 사도들이 마지막 봉인을 두르고 있다. 열만 가라앉히면 창공의 주재가 자네 앞에 일어선다. 그날은 별빛에도 오래 남을 것이다.",
    requiredLevel: 90,
  ...
  // 별을 지키는 자 (starspire) 3종
  {
    ...
    description:
      "별을 지키는 자를 한 번 거두어 별빛이 자네를 알아보게 하시오. 별빛이 자네를 제대로 알아보면, 그 표식은 오래 간다.",
    requiredLevel: 70,
  ...
  // 보상: 별빛 깃든 기예 6권 일괄. 의뢰 완료가 Ch 28 「유성의 마지막 부탁」 의 완료 조건.
  {
    ...
    title: "별빛을 담을 그릇",
    description:
      "별바다에서 시작 마을까지 직접 찾아온 노수호자 유성. 옛 봉인 자리 셋에서 거둔 별빛 조각 30점을 가져가면, 주인 없는 빛을 머물게 할 마지막 그릇을 빚어 두겠다고 한다.",
    requiredLevel: 100,
  ...
  // 한 번이라도 베어 본 자에게만 지미가 운을 뗀다. 보상은 흡령(귀속).
  {
    ...
    title: "별빛 광맥의 깊이",
    description:
      "광맥의 수호자가 별빛에 데워져 다시 깨어났다는 말. 자네가 봤다지. 사람들은 안 믿어. 다섯 번만 거두어 와 주면, 노친네가 옛 광맥 호흡법 한 자락을 자네 몸에 옮겨 둘 테니까.",
    requiredLevel: 100,
