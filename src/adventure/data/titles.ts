...
export const TITLES: Record<TitleId, Title> = {
  ...
  ach_full_gear: {
    id: "ach_full_gear",
    name: "완전무장",
    description: "머리부터 발끝까지 빈틈없이 장비를 갖춘 자.",
  ...
  ach_outpost_scout: {
    ...
    name: "길눈 밝은 자",
    description: "낯선 길에서도 표식을 놓치지 않고 거점을 찾아내는 자.",
  ...
  ach_gold_keeper: {
    id: "ach_gold_keeper",
    name: "금고지기",
    description: "주머니 사정을 숫자로 말할 수 있게 된 자.",
  ...
  ach_boss_master: {
    id: "ach_boss_master",
    name: "거물 토벌자",
    description: "거대한 적들의 이름을 하나씩 지워낸 자.",
  ...
  ach_frontier_end: {
    id: "ach_frontier_end",
    name: "프론티어의 끝",
    description: "개척지의 마지막 표지까지 발자국을 남긴 자.",
  ...
  ach_reborn: {
    id: "ach_reborn",
    name: "다시 태어난 자",
    description: "한 번의 끝을 다음 시작으로 바꾼 자.",
  ...
  ach_rebirth_apex: {
    id: "ach_rebirth_apex",
    name: "윤회의 정점",
    description: "수많은 생을 지나 숙련의 꼭대기에 오른 자.",
  ...
  ach_codex_angler: {
    id: "ach_codex_angler",
    name: "어보 편찬자",
    description: "물살 아래 이름들을 한 권의 기록으로 엮은 자.",
  ...
  ach_field_archaeologist: {
    ...
    name: "현장 고고학자",
    description: "책상보다 흙먼지 위에서 더 많은 시대를 읽은 자.",
  ...
  ach_bestiary_master: {
    ...
    name: "토벌 도감의 주인",
    description: "짐승과 괴물의 흔적을 전투 기록으로 남긴 자.",
  ...
  ach_war_avatar: {
    id: "ach_war_avatar",
    name: "전장의 화신",
    description: "수천 번의 전투 속에서도 흐름을 잃지 않은 자.",
  ...
  ach_plus_ten: {
    id: "ach_plus_ten",
    name: "전설의 단조",
    description: "불꽃과 금속을 끝까지 밀어붙여 전설을 두드린 자.",
