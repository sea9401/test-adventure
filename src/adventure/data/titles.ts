...
export const TITLES: Record<TitleId, Title> = {
  ...
  ach_full_gear: {
    id: "ach_full_gear",
    name: "풀장착러",
    description: "일단 빈 슬롯부터 채우고 보는 타입.",
  ...
  ach_outpost_scout: {
    ...
    name: "길찾기 담당",
    description: "파티에서 자연스럽게 앞장서게 되는 사람.",
  ...
  ach_gold_keeper: {
    id: "ach_gold_keeper",
    name: "짠테크 중",
    description: "작게 모아 크게 쓰는 재미를 아는 사람.",
  ...
  ach_boss_master: {
    id: "ach_boss_master",
    name: "보스 담당",
    description: "어려운 상대가 나오면 슬쩍 시선이 모인다.",
  ...
  ach_frontier_end: {
    id: "ach_frontier_end",
    name: "완주한 사람",
    description: "시작했으면 끝은 봐야 마음이 편한 편.",
  ...
  ach_reborn: {
    id: "ach_reborn",
    name: "다시 시작러",
    description: "처음부터 다시 하는 맛을 알아버렸다.",
  ...
  ach_rebirth_apex: {
    id: "ach_rebirth_apex",
    name: "육성 체질",
    description: "키우는 과정 자체를 꽤 즐기는 사람.",
  ...
  ach_field_archaeologist: {
    ...
    name: "발굴 취미반",
    description: "한 번 파기 시작하면 생각보다 오래 판다.",
  ...
  ach_plus_ten: {
    id: "ach_plus_ten",
    name: "강화 성공러",
    description: "오래 두드린 끝에 결국 원하는 숫자를 봤다.",
