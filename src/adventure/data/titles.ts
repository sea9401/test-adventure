...
export const TITLES: Record<TitleId, Title> = {
  ...
  ach_full_gear: {
    id: "ach_full_gear",
    name: "빈칸 못 참음",
    description: "장비창에 빈칸이 보이면 왠지 손이 떨리는 편.",
  ...
  ach_outpost_scout: {
    ...
    name: "지도 앱 인간",
    description: "처음 가는 길도 대충 아는 척하다가 정말 찾아낸다.",
  ...
  ach_gold_keeper: {
    id: "ach_gold_keeper",
    name: "잔고 확인러",
    description: "돈을 쓰기 전보다 모은 뒤에 더 자주 확인한다.",
  ...
  ach_boss_master: {
    id: "ach_boss_master",
    name: "큰 애 전담",
    description: "작은 일도 잘하지만 이상하게 큰 일에 자주 불려간다.",
  ...
  ach_frontier_end: {
    id: "ach_frontier_end",
    name: "끝까지 와버림",
    description: "잠깐만 더 가보자고 했다가 정말 끝까지 갔다.",
  ...
  ach_reborn: {
    id: "ach_reborn",
    name: "새 계정 아님",
    description: "분명 같은 사람인데 레벨만 다시 어려졌다.",
  ...
  ach_rebirth_apex: {
    id: "ach_rebirth_apex",
    name: "또 키웠어요?",
    description: "이번에도 키웠고, 아마 다음에도 키울 것이다.",
  ...
  ach_codex_angler: {
    id: "ach_codex_angler",
    name: "물고기 출석부",
    description: "낚은 물고기 이름을 체크하는 맛을 알아버렸다.",
  ...
  ach_field_archaeologist: {
    ...
    name: "땅 파면 나옴",
    description: "진짜로 땅을 팠더니 뭐가 나와서 더 파고 있다.",
  ...
  ach_bestiary_master: {
    ...
    name: "처치 목록 담당",
    description: "만난 몬스터를 기억하는 방식이 조금 과격하다.",
  ...
  ach_war_avatar: {
    id: "ach_war_avatar",
    name: "전투 자동응답기",
    description: "전투가 시작되면 몸이 먼저 반응한다. 이제 익숙하다.",
  ...
  ach_plus_ten: {
    id: "ach_plus_ten",
    name: "딸깍 성공",
    description: "수많은 딸깍 끝에 결국 숫자가 두 자리까지 갔다.",
