...
export const TITLES: Record<TitleId, Title> = {
  ...
  v2_unexplored_tracking_weapon: {
    id: "v2_unexplored_tracking_weapon",
    name: "궤도를 끊은 자",
    description: "끝없이 먹잇감을 계산하던 추적 병기의 궤도를 자기 손으로 멈춘 자.",
    condition: "미개척지 개인 보스 추적 병기 최초 처치",
    category: "battle",
  },
  v2_unexplored_toxic_blood_lord: {
    id: "v2_unexplored_toxic_blood_lord",
    name: "독혈을 견딘 자",
    description: "독과 피가 겹쳐진 군주의 맥동을 견디고 그 심장을 꿰뚫은 자.",
    condition: "미개척지 개인 보스 독혈 군주 최초 처치",
    category: "battle",
  },
  v2_unexplored_glacial_colossus: {
    id: "v2_unexplored_glacial_colossus",
    name: "빙하를 무너뜨린 자",
    description: "움직이는 빙하와도 같던 거수를 쓰러뜨리고 절대 한기를 깨뜨린 자.",
