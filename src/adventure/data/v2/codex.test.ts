...
// 2026-06-30: 길드 제작소 제작 재료 4종 추가. 전직 요건 잠금은 유지.
// 2026-07-02: 협동 보스 보상 9종(주화/보스재료/장비상자/숙련 교본) 추가.
// 2026-07-05: 하드 산군 보상 2종(흔적/5T 장비 상자), 심연어룡 보상 2종 추가.
// 2026-07-17: 일반 몬스터 전용 특수 제작 재료 6종 추가.
// 2026-07-24: 3T 중간 지역 특수 제작 재료 3종 추가.
// 2026-08-03: 모든 일반 사냥에서 얻는 활력의 파편 1종 추가.
// 2026-08-03: 수집형 조합 재료(강화의 불씨·찢어진 지도 조각) 2종 추가.
...
describe("v2 코덱스(재료 도감) 진척 — 등재 재료·요건은 플래그 잠금", () => {
  it("V2_CODEX_TOTAL은 채광 광석·부산물과 생활 가공품을 포함한다", () => {
    expect(V2_CODEX_TOTAL).toBe(120);
  });
