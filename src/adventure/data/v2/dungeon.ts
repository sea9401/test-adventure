...
const FLOOR2_ENEMIES: DungeonEnemy[] = [
  ...
  { key: "폐허 늑대", name: "회색 늑대", image: "/images/monster/v2/forest-grey-wolf.webp", element: "lightning", statusSkill: "mob_rending_claw" },
...
const FLOOR3_ENEMIES: DungeonEnemy[] = [
  ...
  { key: "절벽 늑대", name: "절벽 늑대", image: "/images/monster/v2/mountain-cliff-wolf.webp", element: "lightning", statusSkill: "mob_rending_claw" },
...
const FLOOR5_ENEMIES: DungeonEnemy[] = [
  ...
  { key: "운명 직조자", name: "서리 마녀", image: "/images/monster/v2/snow-frost-witch.webp", element: "water", statusSkill: "mob_chilling_touch" },
  ...
  { key: "황성 호위병", name: "빙벽 파수병", image: "/images/monster/v2/snow-icewall-guard.webp", element: "earth", statusSkill: "mob_chilling_touch" },
...
const FLOOR6_ENEMIES: DungeonEnemy[] = [
  ...
  { key: "별빛 동굴뱀", name: "폐허 독사", image: "/images/monster/v2/ruins-viper.webp", element: "void", statusSkill: "mob_venom_bite" },
