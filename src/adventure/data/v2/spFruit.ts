...
// 등급 → 정의. 모든 등급의 사용 캡은 5회 → 캐릭터당 최대 +20 SP.
export const SP_FRUIT: Record<SpFruitTier, SpFruitDef> = {
  1: { materialId: "sp_fruit_1", name: "SP 열매 I", useCap: 5, bossKind: "mountain_chief", spPerUse: 1 },
  2: { materialId: "sp_fruit_2", name: "SP 열매 II", useCap: 5, bossKind: "canyon_predator", spPerUse: 1 },
  3: { materialId: "sp_fruit_3", name: "SP 열매 III", useCap: 5, bossKind: "lake_sovereign", spPerUse: 1 },
  4: { materialId: "sp_fruit_4", name: "SP 열매 IV", useCap: 5, bossKind: "void_priest", spPerUse: 1 },
};
...
export const SP_FRUIT_MATERIALS: Record<string, V2Material> = {
  sp_fruit_1: {
    ...
    name: "SP 열매 I",
    description:
      "산군을 토벌하고 얻는 결정. 사용하면 SP 최대치가 영구히 +1 오른다(캐릭터당 5회). 거래 가능.",
  },
  sp_fruit_2: {
    id: "sp_fruit_2",
    name: "SP 열매 II",
    description:
      "스콜피온 킹을 토벌하고 얻는 결정. 사용하면 SP 최대치가 영구히 +1 오른다(캐릭터당 5회). 거래 가능.",
  },
  sp_fruit_3: {
    id: "sp_fruit_3",
    name: "SP 열매 III",
  ...
  sp_fruit_4: {
    ...
    name: "SP 열매 IV",
    description:
      "공허의 대사제를 토벌하고 얻는 결정. 사용하면 SP 최대치가 영구히 +1 오른다(캐릭터당 5회). 거래 가능.",
  },
};
