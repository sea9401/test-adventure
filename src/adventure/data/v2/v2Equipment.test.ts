...
describe("v2EquipStatRows (표시 행)", () => {
  ...
  it("반지 critMult 옵션 — 위력 + 치명피해 배수 표기(+0.10×)", () => {
    // 은가락지 T1: 위력 2(×2), weight 0, critMult 10(백분의일) → "+0.10×".
  ...
  it("mp 옵션은 % 없이 flat", () => {
    // 마나의 정수 T5: 위력 4(×2), weight 0, mp 50.
