...
const V2_EQUIPMENT_BASE = {
  ...
  v2_stormpeak_greatsword: {
    ...
    power: 780,
    weight: 10,
    options: { hp: 120, def: 34, critResist: 8 },
    weaponType: "greatsword",
    noDrop: true,
    setTags: ["storm_guard"],
  },
  ...
  v2_stormpeak_bow: {
    ...
    power: 668,
    weight: 3,
    options: { crit: 14, critMult: 60, spd: 10 },
    weaponType: "bow",
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  v2_stormpeak_dagger: {
    ...
    power: 584,
    weight: 1,
    options: { eva: 9, critMult: 95, spd: 14 },
    weaponType: "dagger",
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  ...
  v2_stormpeak_raider_gloves: {
    ...
    power: 60,
    weight: 2,
    options: { crit: 16, critMult: 72, spd: 7 },
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  ...
  v2_stormpeak_banner_necklace: {
    ...
    power: 59,
    weight: 0,
    options: { crit: 9, critMult: 55, spd: 11, magicDef: 14 },
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  ...
  v2_abyssruin_greatsword: {
    ...
    power: 822,
    weight: 11,
    options: { hp: 160, def: 38, critResist: 9 },
    weaponType: "greatsword",
    noDrop: true,
  ...
  v2_abyssruin_dagger: {
    ...
    power: 616,
    weight: 1,
    options: { eva: 10, critMult: 100, spd: 15 },
    weaponType: "dagger",
    noDrop: true,
    setTags: ["undertow_hunt"],
  },
  ...
  v2_abyssruin_pincer_gloves: {
    ...
    power: 64,
    weight: 2,
    options: { crit: 17, critMult: 78, spd: 8 },
    noDrop: true,
    setTags: ["undertow_hunt"],
  },
  ...
  v2_abyssruin_sentinel_necklace: {
    ...
    power: 62,
    weight: 0,
    options: { crit: 10, critMult: 60, spd: 12, magicDef: 16 },
    noDrop: true,
    setTags: ["undertow_hunt"],
  },
  ...
  v2_stormpeak_sig_wolf_dagger: {
    ...
    power: 610,
    weight: 1,
    options: { eva: 12, critMult: 105, spd: 16 },
    weaponType: "dagger",
    rarity: "unique",
  ...
  v2_stormpeak_sig_raider_bow: {
    ...
    power: 670,
    weight: 3,
    options: { crit: 16, critMult: 70, spd: 12 },
    weaponType: "bow",
    rarity: "unique",
  ...
  v2_abyssruin_sig_pursuer_bow: {
    ...
    power: 700,
    weight: 3,
    options: { crit: 15, eva: 11, spd: 12 },
    weaponType: "bow",
    rarity: "unique",
    signature: { trigger: "on_dodge", label: "해연", spdBuffPct: 24, buffActions: 2 },
  },
  v2_abyssruin_sig_pincer_gloves: {
    ...
    power: 68,
    weight: 2,
    options: { crit: 18, critMult: 88, spd: 9 },
    rarity: "unique",
