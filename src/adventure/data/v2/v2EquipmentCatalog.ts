...
// V2_EQUIPMENT — 131종. 옛 계파 잔재 정리: 무기종류 8→4(#823)·세트 38→12(#824)·장갑/신발 중갑 폐기
...
export const V2_EQUIPMENT: Record<V2EquipmentId, V2Equipment> = {
  ...
  // 드랍·상점 제외. 정규 T3보다 약간 다른 옵션 결을 주는 장인표 사이드그레이드.
  ...
  v2_crafted_aether_necklace: {
    ...
    power: 5,
    weight: 0,
    options: { mp: 60, magicDef: 7, healPowerPct: 7 },
    craftOnly: true,
    setTags: ["artisan_crafted"],
  },
  v2_crafted_sunforge_blade: {
    ...
    power: 66,
    weight: 5,
    options: { crit: 4, critMult: 20, hp: 80 },
    craftOnly: true,
    setTags: ["artisan_crafted"],
  },
  v2_crafted_aurora_crown: {
    ...
    power: 6,
    weight: 0,
    options: { mp: 90, magicDef: 10, healPowerPct: 10 },
    craftOnly: true,
    setTags: ["artisan_crafted"],
  },
  ...
  // ── 검은 왕도 밴드 드랍 (밴드 G, 깊이 43~48) — 태그 세트(2/3단계) ──────────────────
