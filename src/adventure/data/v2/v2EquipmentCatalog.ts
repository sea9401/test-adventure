...
export const V2_EQUIPMENT: Record<V2EquipmentId, V2Equipment> = {
  ...
  v2_redfield_dagger: {
    ...
    power: 460,
    weight: 1,
    options: { crit: 9, critMult: 95, spd: 6 },
    weaponType: "dagger",
    noDrop: true,
    setTags: ["storm_hunt"],
  },
  v2_redfield_war_armor: {
    ...
    power: 166,
    weight: 13,
    options: { hp: 330, magicDef: 14, critResist: 4 },
    noDrop: true,
    setTags: ["ash_line"],
  },
  ...
  v2_redfield_ember_ring: {
    ...
    power: 44,
    weight: 0,
    options: { critMult: 95, mp: 70, magicDef: 10 },
    noDrop: true,
    setTags: ["ember_rite"],
  },
  v2_redfield_banner_necklace: {
    ...
    power: 45,
    weight: 0,
    options: { crit: 8, spd: 8, magicDef: 10 },
    noDrop: true,
    setTags: ["storm_hunt"],
  },
  ...
  v2_plateau_dagger: {
    ...
    power: 550,
    weight: 1,
    options: { crit: 10, critMult: 110, spd: 8 },
    weaponType: "dagger",
    noDrop: true,
    setTags: ["death_hunt"],
  },
  v2_plateau_bone_armor: {
    ...
    power: 200,
    weight: 14,
    options: { hp: 420, magicDef: 18, critResist: 7 },
    noDrop: true,
    setTags: ["bone_line"],
  },
  ...
  v2_plateau_cairn_ring: {
    ...
    power: 54,
    weight: 0,
    options: { critMult: 110, magicDef: 14 },
    noDrop: true,
    setTags: ["crow_rite"],
  },
  v2_plateau_lord_necklace: {
    ...
    power: 55,
    weight: 0,
    options: { crit: 9, spd: 10, magicDef: 14 },
    noDrop: true,
    setTags: ["death_hunt"],
  },
  ...
  v2_redfield_sig_ash_spear: {
    ...
    power: 620,
    weight: 8,
    options: { crit: 7, critMult: 95, hp: 140 },
    weaponType: "greatsword",
    rarity: "unique",
  ...
  v2_redfield_sig_powder_staff: {
    ...
    power: 600,
    weight: 3,
    options: { mp: 180, crit: 9, magicDef: 18 },
    weaponType: "staff",
    rarity: "unique",
    signature: {
      trigger: "on_crit",
  ...
  v2_redfield_sig_storm_banner: {
    ...
    power: 48,
    weight: 0,
    options: { crit: 10, spd: 10, magicDef: 12 },
    rarity: "unique",
    signature: {
      trigger: "on_crit",
      label: "낙뢰",
  ...
  v2_redfield_sig_ember_ring: {
    ...
    power: 46,
    weight: 0,
    options: { hp: 150, critMult: 85, magicDef: 12 },
    rarity: "unique",
  ...
  v2_plateau_sig_skeleton_lance: {
    ...
    power: 745,
    weight: 9,
    options: { crit: 8, critMult: 110, hp: 170 },
    weaponType: "greatsword",
    rarity: "unique",
  ...
  v2_plateau_sig_crow_staff: {
    ...
    power: 720,
    weight: 3,
    options: { mp: 220, crit: 10, magicDef: 22 },
    weaponType: "staff",
    rarity: "unique",
    signature: {
      trigger: "on_crit",
  ...
  v2_plateau_sig_bone_lord_plate: {
    ...
    power: 210,
    weight: 14,
    options: { hp: 460, magicDef: 24, critResist: 10 },
    rarity: "unique",
    signature: {
      trigger: "low_hp",
      label: "백왕좌",
  ...
  v2_plateau_sig_rider_boots: {
    ...
    power: 56,
    weight: 1,
    options: { eva: 20, spd: 20, magicDef: 10 },
    rarity: "unique",
  ...
  v2_plateau_sig_cairn_crown: {
    ...
    power: 58,
    weight: 0,
    options: { mp: 190, crit: 9, critMult: 90, magicDef: 18 },
    rarity: "unique",
