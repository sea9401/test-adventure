...
const V2_EQUIPMENT_BASE = {
  ...
  // ── 폭풍 원정 전용 6T 장비 ─────────────────────────────────────────────
  // 표시 6T의 첫 카탈로그 단계인 tier 16. 일반 사냥 풀에는 섞지 않고 폭풍 원정의
  // 항로별 직접 드롭·향후 제작/인장 교환으로만 공급한다. 장비가 스탯 토큰을 직접 주지
  // 않는 현행 모델에 맞춰 힘/활력=HP·방어, 민첩/행운=속도·치명, 지능/정신=MP·마방·회복
  // 옵션으로 항로 정체성을 표현한다.
  ...
  v2_storm_wreckage_greatsword: {
    ...
    tier: 16,
    name: "부유섬 파쇄검",
    description: "부유섬의 골격을 통째로 벼린 대검. 내려치는 순간 주변의 중력까지 끌어당긴다.",
    power: 780,
    weight: 0,
    options: { hp: 520, def: 44, critResist: 8 },
    weaponType: "greatsword",
    noDrop: true,
    setTags: ["storm_wreckage"],
  },
  v2_storm_wreckage_armor: {
    ...
    power: 252,
    weight: 0,
    options: { hp: 1050, def: 105, magicDef: 55, critResist: 10 },
    noDrop: true,
    setTags: ["storm_wreckage"],
  },
  v2_storm_wreckage_gloves: {
    ...
    power: 76,
    weight: 0,
    options: { hp: 260, def: 46, crit: 5, critResist: 5 },
    noDrop: true,
    setTags: ["storm_wreckage"],
  },
  v2_storm_wreckage_boots: {
    ...
    power: 74,
    weight: 0,
    options: { hp: 250, def: 40, eva: 5, spd: 3, critResist: 5 },
    noDrop: true,
    setTags: ["storm_wreckage"],
  },
  v2_storm_wreckage_ring: {
    ...
    power: 126,
    weight: 0,
    options: { hp: 330, crit: 4, critMult: 42, critResist: 10 },
    noDrop: true,
    setTags: ["storm_wreckage"],
  },
  v2_storm_wreckage_necklace: {
    ...
    power: 138,
    weight: 0,
    options: { hp: 380, mp: 100, magicDef: 50, healPowerPct: 5, critResist: 10 },
    noDrop: true,
    setTags: ["storm_wreckage"],
  },
  ...
  v2_storm_gale_bow: {
    ...
    power: 760,
    weight: 0,
    options: { crit: 12, critMult: 50, spd: 16 },
    weaponType: "bow",
    noDrop: true,
    setTags: ["storm_gale"],
  },
  ...
  v2_storm_gale_armor: {
    ...
    power: 230,
    weight: 0,
    options: { hp: 700, magicDef: 85, eva: 11, spd: 12 },
    noDrop: true,
    setTags: ["storm_gale"],
  },
  ...
  v2_storm_gale_ring: {
    ...
    power: 120,
    weight: 0,
    options: { crit: 10, critMult: 60, eva: 8, spd: 8 },
    noDrop: true,
    setTags: ["storm_gale"],
  },
  v2_storm_gale_necklace: {
    ...
    power: 126,
    weight: 0,
    options: { hp: 180, mp: 180, magicDef: 48, spd: 14 },
    noDrop: true,
    setTags: ["storm_gale"],
  },
  ...
  v2_storm_thunder_staff: {
    ...
    power: 800,
    weight: 0,
    options: { mp: 320, magicDef: 20, crit: 10 },
    weaponType: "staff",
    noDrop: true,
    setTags: ["storm_thunder"],
  },
  v2_storm_thunder_armor: {
    ...
    power: 238,
    weight: 0,
    options: { hp: 650, mp: 180, magicDef: 105, healPowerPct: 8 },
    noDrop: true,
    setTags: ["storm_thunder"],
  },
  v2_storm_thunder_gloves: {
    ...
    power: 70,
    weight: 0,
    options: { mp: 120, magicDef: 25, crit: 10, healPowerPct: 6 },
    noDrop: true,
    setTags: ["storm_thunder"],
  },
  v2_storm_thunder_boots: {
    ...
    power: 70,
    weight: 0,
    options: { mp: 120, magicDef: 20, eva: 10, spd: 16 },
    noDrop: true,
    setTags: ["storm_thunder"],
  },
  v2_storm_thunder_ring: {
    ...
    power: 122,
    weight: 0,
    options: { mp: 160, magicDef: 30, crit: 8, critMult: 50 },
    noDrop: true,
    setTags: ["storm_thunder"],
  },
  v2_storm_thunder_necklace: {
    ...
    power: 142,
    weight: 0,
    options: { hp: 220, mp: 320, magicDef: 85, healPowerPct: 12 },
    noDrop: true,
    setTags: ["storm_thunder"],
  },
