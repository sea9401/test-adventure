...
const V2_EQUIPMENT_BASE = {
  ...
  v2_stormpeak_greatsword: {
    ...
    tier: 12,
    name: "뇌운 절벽검",
    description: "번개가 긁고 지나간 절벽 철을 눌러 만든 중량검. 먹구름처럼 무겁게 내려앉는다.",
    power: 800,
    weight: 10,
    options: { hp: 140, def: 38, critResist: 9 },
    weaponType: "greatsword",
    noDrop: true,
    setTags: ["storm_guard"],
  },
  v2_stormpeak_staff: {
    ...
    power: 760,
    weight: 3,
    options: { mp: 250, healPowerPct: 12, magicDef: 28 },
    weaponType: "staff",
    noDrop: true,
  ...
  v2_stormpeak_bow: {
    ...
    tier: 12,
    name: "칼바람 장궁",
    description: "산맥 능선의 거친 바람을 시위에 묶었다. 쏘는 순간 화살이 한 번 더 휘어진다.",
    power: 680,
    weight: 3,
    options: { crit: 14, critMult: 65, spd: 10 },
    weaponType: "bow",
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  v2_stormpeak_dagger: {
    ...
    tier: 12,
    name: "절벽송곳",
    description: "바람에 닳은 검은 송곳날. 짧게 찌르고 바위틈처럼 빠져나간다.",
    power: 600,
    weight: 1,
    options: { eva: 9, critMult: 105, spd: 14 },
    weaponType: "dagger",
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  v2_stormpeak_guard_armor: {
    ...
    power: 225,
    weight: 15,
    options: { hp: 500, def: 52, critResist: 12 },
    noDrop: true,
    setTags: ["storm_guard"],
  },
  v2_stormpeak_oracle_robe: {
    ...
    power: 200,
    weight: 5,
    options: { mp: 270, healPowerPct: 13, magicDef: 34 },
    noDrop: true,
    setTags: ["lightning_rite"],
  },
  v2_stormpeak_guard_gloves: {
    ...
    power: 66,
    weight: 5,
    options: { hp: 160, def: 32, critResist: 6 },
    noDrop: true,
    setTags: ["storm_guard"],
  },
  v2_stormpeak_raider_gloves: {
    ...
    tier: 12,
    name: "칼바람 장갑",
    description: "약탈대장이 남긴 손보호구. 손끝의 얇은 날이 치명타를 더 깊게 민다.",
    power: 62,
    weight: 2,
    options: { crit: 16, critMult: 80, spd: 7 },
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  v2_stormpeak_guard_boots: {
    ...
    power: 64,
    weight: 6,
    options: { hp: 180, def: 28, critResist: 5 },
    noDrop: true,
    setTags: ["storm_guard"],
  },
  ...
  v2_stormpeak_thunder_ring: {
    ...
    power: 60,
    weight: 0,
    options: { mp: 130, healPowerPct: 9, magicDef: 22 },
    noDrop: true,
    setTags: ["lightning_rite"],
  },
  v2_stormpeak_banner_necklace: {
    ...
    power: 62,
    weight: 0,
    options: { crit: 9, critMult: 60, spd: 12, magicDef: 14 },
    noDrop: true,
    setTags: ["cliff_hunt"],
  },
  ...
  v2_abyssruin_greatsword: {
    ...
    tier: 12,
    name: "해구 대검",
    description: "해구 바닥의 검은 금속으로 벼린 대검. 휘두르면 무거운 물결이 뒤늦게 따라온다.",
    power: 850,
    weight: 11,
    options: { hp: 180, def: 42, critResist: 10 },
    weaponType: "greatsword",
    noDrop: true,
  ...
  v2_abyssruin_staff: {
    ...
    power: 815,
    weight: 3,
    options: { mp: 290, healPowerPct: 14, magicDef: 34 },
    weaponType: "staff",
    noDrop: true,
    setTags: ["deep_rite"],
  },
  ...
  v2_abyssruin_dagger: {
    ...
    tier: 12,
    name: "청독 단검",
    description: "집게왕의 독빛 껍질을 날에 입혔다. 상처 가장자리마다 푸른 기운이 돈다.",
    power: 640,
    weight: 1,
    options: { eva: 10, critMult: 110, spd: 15 },
    weaponType: "dagger",
    noDrop: true,
    setTags: ["undertow_hunt"],
  },
  v2_abyssruin_guard_armor: {
    ...
    power: 245,
    weight: 16,
    options: { hp: 560, def: 58, magicDef: 24, critResist: 13 },
    noDrop: true,
    setTags: ["trench_guard"],
  },
  v2_abyssruin_apostle_robe: {
    ...
    power: 220,
    weight: 5,
    options: { mp: 320, healPowerPct: 15, magicDef: 40 },
    noDrop: true,
    setTags: ["deep_rite"],
  },
  v2_abyssruin_guard_gloves: {
    ...
    power: 72,
    weight: 5,
    options: { hp: 190, def: 36, critResist: 7 },
    noDrop: true,
    setTags: ["trench_guard"],
  },
  v2_abyssruin_pincer_gloves: {
    ...
    tier: 12,
    name: "청독 집게손",
    description: "집게왕의 날카로운 관절을 덧댄 장갑. 붙잡은 빈틈을 놓치지 않는다.",
    power: 68,
    weight: 2,
    options: { crit: 17, critMult: 85, spd: 8 },
    noDrop: true,
    setTags: ["undertow_hunt"],
  },
  v2_abyssruin_guard_boots: {
    ...
    power: 70,
    weight: 6,
    options: { hp: 210, def: 32, critResist: 6 },
    noDrop: true,
    setTags: ["trench_guard"],
  },
  ...
  v2_abyssruin_tide_ring: {
    ...
    power: 66,
    weight: 0,
    options: { mp: 150, healPowerPct: 10, magicDef: 26 },
    noDrop: true,
    setTags: ["deep_rite"],
  },
  v2_abyssruin_sentinel_necklace: {
    ...
    power: 68,
    weight: 0,
    options: { crit: 10, critMult: 65, spd: 13, magicDef: 16 },
    noDrop: true,
    setTags: ["undertow_hunt"],
  },
  ...
  v2_stormpeak_sig_wolf_dagger: {
    ...
    tier: 12,
    name: "뇌운송곳",
    description: "뇌운 절벽늑대의 송곳니를 닮은 단검. 세 번째 호흡마다 번개처럼 빈틈을 다시 찌른다.",
    power: 650,
    weight: 1,
    options: { eva: 12, critMult: 115, spd: 16 },
    weaponType: "dagger",
    rarity: "unique",
    signature: { trigger: "every_n_hits", label: "뇌운", everyNHits: 3 },
  },
  v2_stormpeak_sig_stormhorn_plate: {
    ...
    power: 235,
    weight: 15,
    options: { hp: 540, def: 60, magicDef: 24, critResist: 13 },
    rarity: "unique",
  ...
  v2_stormpeak_sig_raider_bow: {
    ...
    tier: 12,
    name: "칼바람 약탈궁",
    description: "약탈대장의 전리품으로 남은 검은 활. 치명적인 명중 뒤에 몸이 바람처럼 가벼워진다.",
    power: 700,
    weight: 3,
    options: { crit: 16, critMult: 75, spd: 12 },
    weaponType: "bow",
    rarity: "unique",
    signature: { trigger: "on_crit", label: "칼바람", spdBuffPct: 22, buffActions: 2 },
  },
  v2_stormpeak_sig_oracle_staff: {
    ...
    power: 790,
    weight: 3,
    options: { mp: 280, crit: 8, healPowerPct: 13, magicDef: 30 },
    weaponType: "staff",
    rarity: "unique",
    signature: { trigger: "on_skill_cast", label: "예언", mpRefundPctOfCost: 28 },
  },
  v2_stormpeak_sig_thunder_ring: {
    ...
    power: 64,
    weight: 0,
    options: { hp: 180, mp: 120, magicDef: 24, critResist: 8 },
    rarity: "unique",
    signature: {
      trigger: "battle_start",
      label: "첫천둥",
      battleStartShieldPctMaxHp: 14,
    },
  },
  ...
  v2_abyssruin_sig_pursuer_bow: {
    ...
    tier: 12,
    name: "해연추적",
    description: "깊은 물속의 움직임을 끝까지 따라가는 활. 회피한 뒤에도 다음 사격의 호흡이 끊기지 않는다.",
    power: 750,
    weight: 3,
    options: { crit: 15, eva: 12, spd: 13 },
    weaponType: "bow",
    rarity: "unique",
    signature: { trigger: "on_dodge", label: "해연", spdBuffPct: 26, buffActions: 2 },
  },
  v2_abyssruin_sig_pincer_gloves: {
    ...
    tier: 12,
    name: "청독집게",
    description: "집게왕의 푸른 독샘을 봉한 장갑. 치명타가 터지면 독이 상처 안쪽으로 스며든다.",
    power: 74,
    weight: 2,
    options: { crit: 18, critMult: 95, spd: 9 },
    rarity: "unique",
    signature: { trigger: "on_crit", label: "청독", poisonOnCrit: true },
  },
  v2_abyssruin_sig_sunken_robe: {
    ...
    power: 225,
    weight: 5,
    options: { hp: 260, mp: 280, magicDef: 42, critResist: 10 },
    rarity: "unique",
    signature: { trigger: "low_hp", label: "침몰혼", hpThresholdPct: 35, damageTakenReductionPct: 22 },
  },
  v2_abyssruin_sig_apostle_staff: {
    ...
    power: 845,
    weight: 3,
    options: { mp: 340, healPowerPct: 16, magicDef: 38 },
    weaponType: "staff",
    rarity: "unique",
    signature: { trigger: "on_heal", label: "해구기도", healToShieldPct: 30 },
  },
  v2_abyssruin_sig_sentinel_plate: {
    ...
    power: 255,
    weight: 16,
    options: { hp: 600, def: 64, magicDef: 30, critResist: 14 },
    rarity: "unique",
