...
// V2_EQUIPMENT — 204종. 옛 계파 잔재 정리: 무기종류 8→4(#823)·세트 38→12(#824)·장갑/신발 중갑 폐기
...
const V2_EQUIPMENT_BASE: Record<V2EquipmentId, V2Equipment> = {
  ...
  // 드랍·상점 제외. 대장간 레벨별 구간은 T4~T5 안에서 재료와 수치로 구분한다.
  ...
  v2_crafted_guard_gauntlets: {
    ...
    tier: 4,
    name: "수호각인 건틀릿",
    description: "충격을 손목에서 흘려보내도록 수호 문양을 겹쳐 새긴 장갑.",
    power: 10,
    weight: 1,
    options: { hp: 80, def: 10, critResist: 4 },
    craftOnly: true,
    setTags: ["artisan_guard"],
  },
  v2_crafted_guard_greaves: {
    ...
    tier: 4,
    name: "수호각인 경갑화",
    description: "넘어지지 않는 균형을 위해 발목 보강판을 두껍게 댄 장화.",
    power: 10,
    weight: 1,
    options: { hp: 70, def: 8, critResist: 4 },
    craftOnly: true,
    setTags: ["artisan_guard"],
  },
  v2_crafted_guard_ring: {
    ...
    tier: 5,
    name: "수호각인 반지",
    description: "방어 주문을 얇은 금속층 사이에 눌러 넣은 수호 세트 반지.",
    power: 24,
    weight: 0,
    options: { hp: 110, magicDef: 12, critResist: 5 },
    craftOnly: true,
    setTags: ["artisan_guard"],
  },
  v2_crafted_fury_plate: {
    ...
    tier: 5,
    name: "격노각인 갑주",
    description: "방어판의 모서리를 공격 궤적에 맞춰 세운 격노 세트 갑주.",
    power: 58,
    weight: 5,
    options: { hp: 90, crit: 3, critMult: 35 },
    craftOnly: true,
    setTags: ["artisan_fury"],
  },
  v2_crafted_fury_boots: {
    ...
    tier: 4,
    name: "격노각인 군화",
    description: "짧은 돌진과 재도약에 맞춰 밑창을 단단하게 만든 장화.",
    power: 8,
    weight: 0,
    options: { crit: 4, spd: 8, critMult: 20 },
    craftOnly: true,
    setTags: ["artisan_fury"],
  },
  v2_crafted_fury_necklace: {
    ...
    tier: 5,
    name: "격노각인 목걸이",
    description: "과열된 금속 심지가 공격 순간의 집중을 끌어올리는 목걸이.",
    power: 24,
    weight: 0,
    options: { mp: 60, crit: 4, critMult: 50 },
    craftOnly: true,
    setTags: ["artisan_fury"],
  },
  v2_crafted_pursuit_coat: {
    ...
    tier: 5,
    name: "추격각인 코트",
    description: "몸을 비틀 때 방어판이 늦게 따라오지 않도록 얇게 맞춘 갑옷.",
    power: 52,
    weight: 0,
    options: { hp: 80, eva: 8, spd: 8 },
    craftOnly: true,
    setTags: ["artisan_pursuit"],
  },
  v2_crafted_pursuit_grips: {
    ...
    tier: 4,
    name: "추격각인 손보호구",
    description: "무기 전환과 재장전을 빠르게 만들기 위해 손등을 가볍게 보강했다.",
    power: 8,
    weight: 0,
    options: { crit: 5, eva: 3, spd: 8 },
    craftOnly: true,
    setTags: ["artisan_pursuit"],
  },
  v2_crafted_pursuit_ring: {
    ...
    tier: 5,
    name: "추격각인 반지",
    description: "움직임의 흐름을 끊지 않도록 가벼운 합금으로 만든 반지.",
    power: 22,
    weight: 0,
    options: { crit: 5, eva: 5, spd: 4 },
    craftOnly: true,
    setTags: ["artisan_pursuit"],
  },
  v2_crafted_pursuit_necklace: {
    ...
    tier: 5,
    name: "추격각인 목걸이",
    description: "호흡을 가볍게 유지하도록 마력 흐름을 짧게 순환시키는 목걸이.",
    power: 23,
    weight: 0,
    options: { mp: 70, eva: 5, spd: 6 },
    craftOnly: true,
    setTags: ["artisan_pursuit"],
  },
  v2_crafted_focus_robe: {
    ...
    tier: 5,
    name: "집중각인 로브",
    description: "금속 실을 마력 회로처럼 짜 넣어 주문 집중을 안정시킨 로브.",
    power: 50,
    weight: 0,
    options: { mp: 130, magicDef: 16, healPowerPct: 6 },
    craftOnly: true,
    setTags: ["artisan_focus"],
  },
  v2_crafted_focus_gloves: {
    ...
    tier: 4,
    name: "집중각인 장갑",
    description: "손끝의 마력 손실을 줄이기 위해 얇은 전도판을 댄 장갑.",
    power: 7,
    weight: 0,
    options: { mp: 70, magicDef: 8, healPowerPct: 4 },
    craftOnly: true,
    setTags: ["artisan_focus"],
  },
  v2_crafted_focus_boots: {
    ...
    tier: 4,
    name: "집중각인 장화",
    description: "시전 자세가 흔들리지 않도록 발끝과 뒤꿈치를 균형 있게 보강했다.",
    power: 7,
    weight: 0,
    options: { mp: 60, eva: 4, spd: 5 },
    craftOnly: true,
    setTags: ["artisan_focus"],
  },
  v2_crafted_focus_ring: {
    ...
    tier: 5,
    name: "집중각인 반지",
    description: "작은 마력 회로가 주문의 흔들림을 잡아 주는 집중 세트 반지.",
    power: 21,
    weight: 0,
    options: { mp: 80, magicDef: 10, healPowerPct: 5 },
    craftOnly: true,
    setTags: ["artisan_focus"],
  },
  ...
  // 심연어룡 최종 5티어 보상 세트 — HARD 산군급 희귀 보상 기준.
  // 무기 제외 3피스라 모든 직군이 자기 무기/전문화는 유지한다. 단계형 setTags 로 2/3세트 보너스를 준다.
  v2_boss_abyssal_armor: {
    ...
    name: "심연 해류갑",
    description:
      "심연어룡의 비늘을 겹쳐 엮은 흉갑. 물살처럼 충격을 흘리고 숨을 깊게 만든다.",
    power: 210,
    weight: 8,
    options: { hp: 760, def: 70, magicDef: 75, critResist: 6 },
    rarity: "unique",
  ...
  v2_boss_abyssal_ring: {
    ...
    name: "심연 해류반지",
    description:
      "검푸른 물결이 안쪽에서 도는 반지. 빈틈을 잡는 감각과 마력의 흐름을 함께 깨운다.",
    power: 104,
    weight: 0,
  ...
  v2_boss_abyssal_necklace: {
    ...
    name: "심연 해류목걸이",
    description:
      "소용돌이 중심에서 건져 올린 핵을 단 목걸이. 오래 버티는 전투에서 호흡을 안정시킨다.",
    power: 112,
    weight: 0,
  ...
  // ── 검은 왕도 밴드 드랍 (밴드 G, 깊이 43~48, T5) — 태그 세트(2/3단계) ───────────────
...
function applyEquipmentCatalogScales(
  ...
  return Object.fromEntries(
    Object.entries(catalog).map(([id, item]) => {
      ...
      const scaledPower =
        item.slot === "weapon"
          ? Math.max(1, Math.round(item.power * WEAPON_POWER_SCALE))
          : item.power;
      const power =
