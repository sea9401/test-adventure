...
//
// 주기: 일일 = KST 자정, 주간 = 월요일 00:00 KST (guildQuests.thisWeekStartKST 와
// 동일 규칙 — 시즌 크론들과 정합. 순수 모듈이라 자체 구현).
...
export const REPEAT_QUESTS: readonly RepeatQuestDef[] = [
  ...
  },
  {
    ...
    scope: "weekly",
    title: "주간 공성",
    desc: "이번 주 점령전에서 3회 승리하세요.",
    goal: 3,
    reward: { gold: 10000 },
    progress: diff("siegeWins"),
  },
  {
    id: "w_treasury",
    scope: "weekly",
    title: "주간 금고 사냥",
    desc: "이번 주 거점 금고에서 5,000 G 를 회수하세요.",
    goal: 5000,
    reward: { gold: 8000 },
    progress: diff("warTreasuryGold"),
  },
  {
    id: "w_fish",
    scope: "weekly",
