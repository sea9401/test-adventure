...
export const V2_COMMON_SKILLS: Record<V2CommonSkillId, V2SkillDefinition> = {
  ...
  v2c_duelist_declaration: {
    ...
    description: "다음 평타 3회의 피해와 치명타 확률을 높인다.", mpCost: 32, cooldown: 5, procChance: 100, spCost: 8,
  ...
  v2c_duelist_balance: {
    ...
    description: "힘·행운·민첩이 각각 8% 오른다.", mpCost: 0, cooldown: 0, spCost: 6,
    effects: [], passive: { statPct: { str: 8, luk: 8, dex: 8 } },
  },
  v2c_contender_insight: {
    id: "v2c_contender_insight", name: "빈틈 간파", stat: "luk", category: "buff", tier: 3,
    description: "다음 평타 3회가 대상 방어력을 추가로 관통한다.", mpCost: 36, cooldown: 5, procChance: 100, spCost: 10,
  ...
  v2c_contender_precision: {
    ...
    description: "평타가 대상 방어력을 10% 추가 관통한다.", mpCost: 0, cooldown: 0, spCost: 7,
    effects: [], passive: { basicDefPenetrationPct: 10 },
  },
  v2c_undefeated_momentum: {
    id: "v2c_undefeated_momentum", name: "무패의 기세", stat: "str", category: "buff", tier: 3,
    description: "다음 평타 4회가 이어질수록 피해가 5%씩 오른다.", mpCost: 40, cooldown: 6, procChance: 100, spCost: 13,
  ...
  v2c_undefeated_rhythm: {
    ...
    description: "평타 치명타 발생 시 다음 행동 간격이 8% 짧아진다.", mpCost: 0, cooldown: 0, spCost: 8,
    effects: [], passive: { basicCritHastePct: 8 },
  },
  v2c_grandchampion_hour: {
    id: "v2c_grandchampion_hour", name: "챔피언의 시간", stat: "luk", category: "buff", tier: 3,
    description: "다음 평타 5회의 치명타 배율과 치명타 확률 상한을 높인다.", mpCost: 44, cooldown: 7, procChance: 100, spCost: 16,
  ...
  v2c_grandchampion_instinct: {
    ...
    description: "평타 치명타 확률 상한이 85%로 오른다.", mpCost: 0, cooldown: 0, spCost: 10,
