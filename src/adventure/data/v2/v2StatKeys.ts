...
//
// 6 1차 (각 직업군 앵커): 힘(검술)·민첩(인술)·활력(체술)·지능(마술)·정신(신술)·행운(궁술).
...
export const V2_STAT_DESCRIPTIONS: Record<V2StatKey, string> = {
  str: "물리 공격력·최소 데미지. 명중·치명타 피해 보조. (검술)",
  dex: "속도(행동 순서·다중공격). 명중·회피 보조. (인술)",
  vit: "물리 방어력·최대 HP·회복량. (체술)",
  int: "마법 공격력·최소 데미지. 마법 방어 소량. (마술)",
  spi: "마법 방어력·치명타 저항·회복·명중. (신술)",
  luk: "치명타 확률·치명타 피해. 회피 보조. (궁술)",
};
