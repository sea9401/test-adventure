...
export const V2_STAT_DESCRIPTIONS: Record<V2StatKey, string> = {
  str: "물리 공격력·물리 스킬 최소 데미지·최대 HP. 생애 시작 힘은 HP 성장 최솟값을 높임. 명중·치명타 피해 보조.",
  dex: "속도. 명중·회피 보조.",
  vit: "물리 방어력·최대 HP·회복량·물리 스킬 최소 데미지. 활력의 수행 한계는 HP 성장 최댓값을 높임.",
  int: "마법 공격력·마법 스킬 최소 데미지. 최신 성장 방식에서 보정 전 지능의 15 초과분은 현재 최대 MP에 더해짐. 지능의 수행 한계는 MP 성장 최댓값을 높임. 마법 방어 보조.",
  spi: "마법 방어력·치명타 저항·회복·명중·마법 공격 보조·마법 스킬 최소 데미지. 최신 성장 방식에서 보정 전 정신의 15 초과분은 현재 최대 MP에 더해짐. 재전직 때 정해지는 생애 시작 정신은 다음 생애의 시작 MP와 MP 성장 최솟값을 높임. 계산식은 게임안내서 참고.",
