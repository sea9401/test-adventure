...
export const V2_STAT_DESCRIPTIONS: Record<V2StatKey, string> = {
  str: "물리 공격력·물리 스킬 최소 데미지. 명중·치명타 피해 보조.",
  dex: "속도. 명중·회피 보조.",
  vit: "물리 방어력·최대 HP·회복량·물리 스킬 최소 데미지.",
  int: "마법 공격력·마법 스킬 최소 데미지. 마법 방어 보조.",
  spi: "마법형 적 대응의 핵심. 마법 방어력·치명타 저항·회복·명중·마법 스킬 최소 데미지.",
