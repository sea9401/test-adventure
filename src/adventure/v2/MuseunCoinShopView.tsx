...
function CashItemIcon({
  ...
  if (artPath) {
    ...
    return (
      <span
        aria-hidden
        className="relative inline-flex shrink-0 overflow-hidden rounded-xl border border-amber-200 bg-amber-50 shadow-sm dark:border-amber-800 dark:bg-amber-950"
