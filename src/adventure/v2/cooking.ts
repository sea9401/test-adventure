...
export const COOKING_RECIPES: readonly CookingRecipe[] = [
  ...
  recipe({ id: "country_egg_bread", name: "시골식 달걀빵", icon: "🥚", requiredLevel: 1, farmIngredients: { wheat: 8, egg: 4 }, xp: 13, baseStatPct: { str: 5 }, description: "갓 구운 빵과 달걀로 힘을 북돋우는 소박한 목장식입니다." }),
