...
import { FAILED_DISH_FEED_RECIPE, RANCH_FEED_RECIPE } from "./ranch";
...
export const LIFE_CRAFTING_RECIPES: readonly LifeCraftingRecipe[] = [
  ...
  { id: "organic_fertilizer", name: "유기질 거름", description: "자라는 중인 밭에 사용해 남은 재배 시간을 20%(최대 2시간) 줄이고, 수확량을 1개 늘립니다. 파종당 1회만 사용합니다.", image: "/images/items/life-aids/organic_fertilizer.webp", kind: "aid", outputId: "organic_fertilizer", outputAmount: 3, costs: { [P.softwood]: 3, [M.coal]: 3 }, requiredLevel: 1 },
