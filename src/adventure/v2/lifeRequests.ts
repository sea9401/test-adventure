...
const REQUESTER_SPECIAL_REQUESTS: readonly LifeRequestDefinition[] = [
  ...
  { id: "special_rosa_prep", scope: "weekly", grade: "skilled", requesterId: "innkeeper", requesterSpecial: true, requiredRequesterTrust: LIFE_REQUEST_TRUST_SPECIAL_UNLOCK, lane: "crafting", activity: "cooking", title: "로사의 특별 주문 · 잔칫날 준비", description: "마을 잔칫날 조리대에 배치할 준비 세트를 넉넉히 지원합니다.", itemKind: "crafted", itemId: "cooking_prep_set", quantity: 20, rewardGold: 18_000, rewardXp: 110 },
  { id: "special_theo_bait", scope: "weekly", grade: "skilled", requesterId: "fishing_master", requesterSpecial: true, requiredRequesterTrust: LIFE_REQUEST_TRUST_SPECIAL_UNLOCK, lane: "crafting", activity: "fishing", title: "테오의 특별 주문 · 먼바다 출조", description: "먼바다 출조대가 사용할 정갈한 미끼 상자를 지원합니다.", itemKind: "crafted", itemId: "tidy_bait_box", quantity: 3, rewardGold: 18_000, rewardXp: 110 },
];
