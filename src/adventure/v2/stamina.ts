...
// 2026-07-20 사용자 결정 — 일반 2분당 10(12초/1), 지원권은 +20%로 2분당 12(10초/1).
// 2026-06-30 사용자 결정 — 모든 유저 기본 최대치 +3000, 신규 캐릭터 기본 만피 5000.
// 2026-07-20 사용자 결정 — 기본 최대치를 1500 으로 하향. 지원권 활성 시 별도 +1000.
// 2026-08-08 사용자 결정 — 수면 중 완충 압박을 줄이기 위해 기본 2000, 지원권 총 3000 으로 상향.
export const MAX_STAMINA = 2000;
export const REGEN_SECONDS_PER_POINT = 12; // 일반 2분 = 10 stamina
...
//   기본 2000 * 12 s = 24000 s = 6시간 40분.
// 지원권은 10초/1, 최대 3000 기준 완충까지 8시간 20분.
