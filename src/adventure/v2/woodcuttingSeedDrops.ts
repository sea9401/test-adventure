...
export const WOODCUTTING_SEED_DROP_RATES: readonly WoodcuttingSeedDropRate[] = [
  ...
  { cropId: "herb", grade: 1, chancePerMillion: 3_000 }, // 0.30%
  { cropId: "corn", grade: 2, chancePerMillion: 2_000 }, // 0.20%
  { cropId: "tomato", grade: 3, chancePerMillion: 1_500 }, // 0.15%
  { cropId: "strawberry", grade: 3, chancePerMillion: 1_200 }, // 0.12%
  { cropId: "potato", grade: 4, chancePerMillion: 1_000 }, // 0.10%
  { cropId: "onion", grade: 4, chancePerMillion: 700 }, // 0.07%
  { cropId: "rice", grade: 5, chancePerMillion: 500 }, // 0.05%
  { cropId: "soybean", grade: 5, chancePerMillion: 350 }, // 0.035%
  { cropId: "sugarcane", grade: 6, chancePerMillion: 150 }, // 0.015%
  { cropId: "cacao", grade: 6, chancePerMillion: 50 }, // 0.005%
];
