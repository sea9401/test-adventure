...
// POST /api/v2/me/use-sp-fruit — SP 열매(협동 보스·폭풍 원정·미개척지 보상) 1개 사용 → SP 최대치 +1(영구).
//   body { tier } — 1|2|3|4|5|6. 보유(character.v2.materials[materialId]) + 사용 캡(spFruitUsed[tier] <
