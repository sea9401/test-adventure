...
// flag-on 운영에서 V2CultivationView 가 /api/v2/me/state 의 jobsV2 로 넘기는 모양과 동일한 mock.
...
const BASE_JOBS: JobLadderEntry[] = [
  { id: "warrior", name: "견습 병사", tier: 1, condition: "Lv 50 달성" },
  { id: "martial", name: "견습 무인", tier: 1, condition: "Lv 50 달성" },
  { id: "mage", name: "견습 마법사", tier: 1, condition: "Lv 50 달성" },
  { id: "rogue", name: "견습 도적", tier: 1, condition: "Lv 50 달성" },
];

const WARRIOR_UPPER: JobLadderEntry[] = [
  { id: "shieldman", name: "방패병", tier: 2, condition: "견습 병사 누적 Lv 100" },
  { id: "squire", name: "견습 기사", tier: 2, condition: "견습 병사 누적 Lv 100" },
];
  ...
  return (
    <div className="mx-auto max-w-md space-y-6 p-4">
      <div className="rounded-lg border border-amber-300 bg-amber-50 p-3 text-xs text-amber-900 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-200">
        <strong>직업 사다리 프리뷰</strong> — flag-on 전직 화면(V2JobLadder) 렌더 확인.
      ...
      <Scenario
        ...
        note="atLevelCap=true · 기본 4직업만 해금(상위는 누적 레벨 부족). 전직 버튼 활성."
      >
        <V2JobLadder
          level={50}
          currentJobName="모험가"
