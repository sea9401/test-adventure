...
export function CombatFormulasContent() {
  return (
    <>
      ...
      <H3>중독 계산</H3>
      <P>
        플레이어 장비에서 발생하는 독은 <Em>공격력과 행운 중 높은 값</Em>을 피해 기준으로 저장하고
        독 강화 보정을 한 번 적용합니다. 아래 식의 시전 시 공격력은 장비 독에서는 이 기준값을 뜻합니다.
        몬스터 독의 생성 기준은 바뀌지 않습니다.
      </P>
      <P>
        살아 있는 독에 새 독을 더하면 중첩은 기존 상한까지 누적하고,
        대상 최대 HP와 보스 보정을 반영해 더 강한 독의 중첩당 피해 계산을 유지합니다.
        서로 다른 독의 계수를 각각 최댓값으로 조합하지 않습니다. 남은 지속시간은 더 긴 값을 사용하며 만료된 독은 보존하지 않습니다.
      </P>
      <UL>
        <li>
      ...
      <H3>지속 피해 적용 순서</H3>
      <P>
        출혈·중독·연소의 지속 피해 자체에는 스킬 치명타가 발생하지 않습니다. 상태이상을
        거는 스킬에 직접 타격 피해가 있으면 그 직접 피해는 치명타가 발생할 수 있습니다.
      </P>
      <P>
