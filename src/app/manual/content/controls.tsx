  ...
  return (
    <>
      ...
      <P>
        ...
        이후 친구가 지정된 사냥터의 최심부를 돌파할 때마다 신규 모험가와
        홍보자 양쪽의 우편함에 스태미나 회복약 2개가 추가로 도착합니다. 합류한
        모험가의 현재 사냥터와 보상 진척도도 이 탭에서 확인할 수 있습니다. 쿠폰
        등록 탭에서는 쿠폰 코드를 입력해 보상을 우편함으로 받을 수 있습니다.
      </P>
