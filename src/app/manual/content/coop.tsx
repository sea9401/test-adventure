...
export function CoopContent() {
  return (
    <>
      ...
      <H2>무료 토벌 지원</H2>
      <P>
        목록의 <Em>소환 시 자동 무료 지원</Em> 설정을 켜면 다음 소환부터 무료 토벌 지원을
        허용합니다(기본 꺼짐). 설정은 계정에 저장되며 낚시로 출현하는 보스에도 적용됩니다.
        이미 소환한 보스는 상세 화면이나 <Em>내 보스 일괄 설정</Em>에서 켜거나 끌 수 있습니다.
        기존 공개 범위 안의 모험가가 무료 지원 버튼으로
      ...
      <P>
        ...
        목록의 <Em>내 보스 일괄 설정</Em>에서 진행 중인 내 보스들의 무료 지원과 공개 범위를
        한 번에 변경할 수 있습니다. 변경 안 함을 선택한 항목은 유지하며, 종료된 보스와
        전체 공개 보스의 범위 축소는 건너뜁니다. 소속 길드가 없으면 길드원만 설정은 나만으로 적용됩니다.
      </P>
