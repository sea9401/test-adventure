  ...
  return (
    <>
      ...
      <UL>
        ...
        <li>
          <Em>연습 전투</Em>는 오늘의 실전 공격을 모두 사용했거나 토벌전이 끝난 뒤에도
          이용할 수 있으며 공격 횟수를 소모하지 않습니다. 연습 피해는 개인·길드
          기여도, 보상 자격과 최근 전투 기록에 기록되지 않습니다.
        </li>
        <li>
          첫 유효 공격을 한 길드에 그 주의 참여가 고정됩니다. 주중에 다른 길드로
          옮기면 새 길드에서는 공격할 수 없고, 이미 기록한 피해와 공격 횟수는 그대로
          유지되며 원래 참여 길드의 보상 자격도 보존됩니다.
        </li>
        <li>
        ...
        <li>길드 순위와 현재 길드의 최근 전투 기록은 한 페이지에 8개씩 표시됩니다.</li>
      </UL>
      ...
      <P>
        시설 성장과 별개로 마스터와 관리자는 길드 자금 3,000만 G로
        <Em>주간 길드원 지원품</Em>을 마련할 수 있습니다. 결제 당시 길드원 모두에게
        귀속 스태미나 회복약 3개씩 우편으로 보냅니다. 한 길드에서 한국 시간 기준
        주마다 한 번만 마련할 수 있으며, 다음 월요일 00:00에 다시 열립니다.
      </P>
