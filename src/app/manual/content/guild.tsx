  ...
  return (
    <>
      ...
      <P>
        ...
        나머지는 금고로 들어갑니다. 자세한 내용은 <Em>지도·거점·정착지</Em>에서
        확인할 수 있습니다.
      </P>
      ...
      <UL>
        ...
        <li>
          ...
          소멸하고 점령 거점도 모두 해제됩니다. 해산은 되돌릴 수 없습니다.
        </li>
      </UL>

      <Note>
        길드는 거점·연구·시설을 함께 운영하는 장기 성장 단위입니다. 시설마다
        재료와 주간 초기화 시점이 다르므로 관리 화면에서 남은 목표를 확인해 주세요.
      </Note>
    </>
  );
}
