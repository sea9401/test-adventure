...
export function HuntingContent() {
  return (
    <>
      ...
      <H2>미개척지 특화 사냥</H2>
      <P>
        깊이 79를 개척하면 사냥 화면의 <Em>미개척지 특화 사냥</Em>에서 방식을 선택할 수 있습니다.
        원하는 몬스터군과 전용 장비를 확인하고 선택을 저장한 뒤 사냥합니다.
        특화 선택은 79~84단계의 일반 사냥에 적용됩니다. 희귀맵에는 적용되지 않으며,
        탐사 노드를 선택한 미개척지 사냥은 해당 노드의 몬스터와 보상 규칙을 따릅니다.
      </P>
      <Table
        head={["방식", "대상", "전용 장비 기본 드롭률"]}
        rows={[
          ["일반 사냥", "기존 별의 무덤 몬스터와 드롭", "특화 전용 장비 대상 아님"],
          ["무작위 특화", "12개 몬스터군 중 매 전투 무작위 선택", "0.4%"],
          ["집중", "선택한 몬스터군", "0.6%"],
        ]}
      />
      <P>
