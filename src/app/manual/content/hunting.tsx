  ...
  return (
    <>
      ...
      <P>
        ...
        30분 동안 소모품으로 보관되고, 성장맵은 전투 탭 → 사냥터의{" "}
        <Em>발견한 지도</Em>에서, 유틸맵은 가방의 소모품 탭에서 사용합니다.
      </P>
      <Table
        ...
        caption="성장맵 사냥은 입장한 지도의 발견 깊이로만 진행됩니다. 지도는 발견 후 30분 동안 유효하고, 판수는 승패와 무관하게 소모되며, 레어맵 안에서는 또 다른 레어맵이 발견되지 않습니다."
      />
      <Table
        ...
        caption={`유틸맵은 사냥터가 아니라 숨겨진 기능 입장권입니다. 지도는 발견 후 30분 동안 유효하며, 보유 레어맵은 최대 ${RARE_MAP_CAP}장까지 들 수 있습니다.`}
      />
