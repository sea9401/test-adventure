  ...
  return (
    <>
      ...
      <P>
        ...
        레벨 {V2_LEVEL_CAP}에 도달하면 조건을 갖춘 상위 직업으로 전직할 수
        있습니다. 전직에 골드는 들지 않습니다.
      </P>
      <P>
      ...
      <Note>
        레벨 {V2_LEVEL_CAP}에 도달한 뒤 전직을 거듭하며 직업 계보를 넓히는 것이
        장기 성장의 중심입니다. 직업 숙련도는 재전직 후에도 유지됩니다.
      </Note>
      ...
      <UL>
        ...
        <li>
          <Em>직업 숙련도</Em>는 실제 직업으로 사냥에서 승리할 때마다 1씩
          쌓이며 전직해도 줄지 않습니다. 전직 조건과 스탯 하한의 기준이 됩니다.
