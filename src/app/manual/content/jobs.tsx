...
export function JobsContent() {
  return (
    <>
      ...
      <P>
        상위 직업은 <Em>바로 아래 직업의 누적 레벨</Em>이 게이트를 넘으면 열립니다.
        계보가 깊어질수록 게이트가 높아져요(누적 레벨 {TIER2_UNLOCK_CUMLEVEL} →{" "}
      ...
      <UL>
        <li>
          ...
          성장합니다. 단 <Em>숙달 포인트·누적 레벨·스탯 한계·배운 스킬</Em>은
          그대로 유지돼요 — 레벨 리셋이 유일한 대가입니다.
        </li>
        <li>
          <Em>현재 직업으로 다시 전직</Em>(재전직)해 누적 레벨을 계속 쌓는 환생
          루프도 가능합니다.
        </li>
        <li>
      ...
      <UL>
        <li>
          몬스터를 처치할 때마다 <Em>숙달 포인트</Em>가 직군별로 쌓입니다(깊은
          사냥터일수록 많이).
        </li>
        <li>
        ...
        <li>
          <Em>누적 레벨</Em>은 레벨업마다 +1 씩 쌓이고 전직해도 줄지 않아요 —
