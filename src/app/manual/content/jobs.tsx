...
export function JobsContent() {
  return (
    <>
      <H2>직군과 직업 사다리</H2>
      <P>
        직업은 <Em>전사·무도가·마법사·도적</Em>과 보조 계열인 <Em>생존자</Em>로
        나뉩니다. 각 직군은 <Em>견습 직업</Em>에서 시작해 전직 조건을 갖추면 상위
        직업으로 올라갑니다. 직군마다 성장을 이끄는 앵커 스탯이 다릅니다.
      </P>
      <Table
        head={["직군", "앵커", "시작 직업"]}
        rows={[
        ...
        caption="방패병·기사·마도사 등 상위 직업의 전체 계보는 모험의 서 → 직업에서 확인할 수 있습니다."
      />
      <JobRoadmap />
      ...
      <UL>
        ...
        <li>
          <Em>직업 전용 스킬</Em> — 상위 직업일수록 더 강한 스킬을 배울 수
      ...
      <P>
        모든 직업의 <Em>레벨 상한은 {V2_LEVEL_CAP}</Em>입니다. 시작 직업은
      ...
      <P>
        ...
        계보가 깊어질수록 필요한 숙련도가 높아집니다({TIER2_UNLOCK_CUMLEVEL} →{" "}
      ...
      <UL>
        <li>
          전직하면 <Em>레벨이 1로</Em> 돌아가고 이번 직업 스탯도 하한부터 다시
          성장합니다. <Em>숙달 포인트·직업 숙련도·스탯 한계·배운 스킬</Em>은
          그대로 유지됩니다.
        </li>
        <li>
      ...
      <UL>
        ...
        <li>
          낚시는 예외적으로 현재 다른 직업이어도 전직해 본 낚시 직업 중
          <Em>가장 높은 차수</Em>의 숙련도가 챔질 성공당 1 오릅니다. 낚시 직업
          이력이 없으면 직업 숙련도가 오르지 않으며, 생존자 직군 숙련도는
          별도로 지급하지 않습니다.
        </li>
        <li>
          모험가 상태에서는 전투 직업 숙련도가 오르지 않습니다.
        </li>
      </UL>
      ...
      <UL>
        ...
        <li>
          최고층과 체크포인트는 주간 초기화 없이 유지됩니다. 역대 최고층 기준으로
          10층 단위 체크포인트를 돌파하면 새 등반을 1층 또는 최근 체크포인트의
          다음 층에서 시작할 수 있습니다. 최초 돌파 보너스 기록도 유지되며,
          일일 진행과 보상 수령 여부는 매일 초기화됩니다.
        </li>
        <li>
