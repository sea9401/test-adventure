...
export function PastimesContent() {
  return (
    <>
      ...
      <UL>
        <li>
          밭에 씨앗을 심고 성장 시간이 지나면 수확합니다. 수확한 밭마다 해당 씨앗 1개를 돌려받을 수 있으며, 반환 확률은 농사 1레벨 30%에서 100레벨 55%까지 매 레벨 증가합니다. 농장은 처음{" "}
      ...
      <P>생활 숙련도 랭킹에는 농사 레벨이 50을 넘어도 실제 레벨을 합산합니다.</P>
      <H2>개인 요리</H2>
      <P>
        요리 도감에서 수량을 1~20개로 골라 <Em>일괄 제작</Em>할 수 있습니다.
      ...
      <UL>
        ...
        <li>
          <Em>수동 벌목에 성공하면</Em> 농장 씨앗 1개를 발견할 수 있습니다. 발견 확률은 벌목 1레벨 1.495%에서 100레벨 5%까지 매 레벨 증가합니다.
      ...
      <UL>
        ...
        <li>
          ...
          이어지면 바늘이 빠집니다. 새 조우는 장력이 안전 구간 아래로 내려가도
          <Em>2초 동안</Em> 다시 감아올릴 수 있습니다.
        </li>
        <li>
      ...
      <Table
        ...
        rows={[
          ...
          ["심연 응축 미끼", "전설 어종(거대어 제외) 출현 가중치 +100%", "시작 어체력 10%·모든 행동 장력 충격 12% 감소"],
        ]}
        caption="출현 가중치는 확정 확률이 아닙니다. 전설 어종은 거대어가 아니며, 특수 미끼의 어종 유인과 조우 효과는 위험 해역에만 적용됩니다."
      />
      ...
      <Table
        head={["단계", "강화 비용"]}
        rows={[
          ["+1", "일반 등급 위험 해역 어획물 6개 + 희귀 등급 위험 해역 어획물 4개 + 낚시 코인 1,000"],
          ["+2", "희귀 등급 위험 해역 어획물 8개 + 영웅 등급 위험 해역 어획물 5개 + 낚시 코인 3,000"],
          ["+3", "영웅 등급 위험 해역 어획물 8개 + 전설 등급 위험 해역 어획물 3개 + 낚시 코인 8,000"],
        ]}
      ...
      <P>
        ...
        위험 해역 어획물은 일반 낚시의 요리용 어획물과는 별도 재료입니다.
      ...
      <Table
        head={["소모", "지급"]}
        rows={[
          ["일반 등급 위험 해역 어획물 4개", "암초 향 미끼 5개"],
          ["희귀 등급 위험 해역 어획물 4개", "핏빛 미끼 5개"],
          ["영웅 등급 위험 해역 어획물 3개", "발광 미끼 5개"],
          ["전설 등급 위험 해역 어획물 2개", "심연 응축 미끼 5개"],
        ...
        caption="장비·칭호·프로필 테두리는 한 번만 교환할 수 있습니다. 기존 낚시 코인 단독 장비·특수 미끼 구매 경로도 그대로 유지됩니다."
      />
      ...
      <UL>
        ...
        <li>
          낚시 레벨은 물고기 크기와 물때 특별 손님 등장 확률을 조금 올리고,
          요리용 어획물 획득 확률을 25%에서 최대 40%까지 높여 줍니다.
