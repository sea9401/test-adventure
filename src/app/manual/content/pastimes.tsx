...
export function PastimesContent() {
  return (
    <>
      ...
      <Table
        head={["미끼", "위험 해역 실시간 효과"]}
        rows={[
          ["해역용 기본 미끼", "추가 실시간 효과 없음"],
          ["암초 향 미끼", "급선회 중 거리 회복·장력 충격 20% 감소"],
          ["핏빛 미끼", "돌진·몸부림 중 어체력 피해 20% 증가"],
          ["발광 미끼", "다음 행동 1개 예고·잠수 속도 15% 감소"],
          ["심연 응축 미끼", "시작 어체력 10%·모든 행동 장력 충격 12% 감소"],
        ]}
        caption="특수 미끼 효과는 위험 해역의 실시간 조우에만 적용되며 일반 낚시는 바뀌지 않습니다."
      />
