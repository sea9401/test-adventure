...
export function PlazaContent() {
  return (
    <>
      ...
      <H2>거래소</H2>
      <P>
        점검 중 진행 중이던 경매는 점검과 겹친 시간만큼 입찰 마감·만료 시각이 연장됩니다.
        점검 중에는 경매 정산이 보류되며, 이미 종료된 경매를 다시 열거나 같은 점검 시간을 중복 가산하지 않습니다.
        요리 매물은 품질에 따른 실제 음식 효과와 지속시간을 확인한 뒤 입찰할 수 있습니다.
      </P>
      <P>
