  ...
  return (
    <>
      ...
      <P>
        ...
        관련 숙련도가 높을수록 성장 범위와 넓은 범위를 선택할 확률이 커집니다. 같은 정수 범위 안에서도 평균 성장량은 계속 증가합니다. 한 스탯이 많이 올라도
        다른 스탯의 성장량에는 영향을 주지 않습니다. 레벨당 총량 제한은 없으며,
        한계치에 닿은 스탯의 남은 성장량은 다른 스탯으로 옮겨지지 않습니다. 재전직 시작 스탯은 그때의 관련 숙련도로 정해지고, 다음 재전직까지 시작값을 유지합니다.
      </P>
