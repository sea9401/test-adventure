...
//   "방금 일어난 것"만 보여주는 라이브 띠 — 폴링(FEED_POLL_MS=30s) 주기가 이보다 훨씬
//   짧아 접속 중 새 사건은 다 잡힌다. 좁게 잡는 이유: 유저가 많아져 사건이 쏟아질 때
//   재접속 시 24시간 치를 다 흘리면 전광판이 끝없이 길어지는 것 방지(사용자 결정 2026-06-22).
export const WAR_TICKER_WINDOW_MIN = 5;
