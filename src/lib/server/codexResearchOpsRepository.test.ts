...
function rawRow(overrides: Record<string, unknown> = {}) {
  return {
    ...
    start_at: new Date("2026-08-31T15:00:00.000Z"),
    end_at: new Date("2026-09-30T15:00:00.000Z"),
    status: "closed",
    settled_at: new Date("2026-09-30T16:00:00.000Z"),
    progress_count: "12",
    scored_count: "10",
    final_rank_count: "10",
    bronze_count: "1",
...
describe("codex research operations repository", () => {
  ...
  it("parses bounded aggregate counts and derives deterministic states", async () => {
    const fake = executeFake([
      ...
      rawRow({
        season_id: "2026-10",
        start_at: new Date("2026-09-30T15:00:00.000Z"),
        end_at: new Date("2026-10-31T15:00:00.000Z"),
        status: "active",
        settled_at: null,
        progress_count: 2,
        scored_count: 1,
