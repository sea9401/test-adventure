...
export const COOKING_EXPANSION_ANSWER_BATCH_15 = {
  ...
  { recipeId: "white_strawberry_royal_cacao_crystal_sugar_milk_pork_bread", ingredientIds: ["farm:white_strawberry","farm:royal_cacao","farm:crystal_sugarcane","farm:milk","processed:flour"] },
