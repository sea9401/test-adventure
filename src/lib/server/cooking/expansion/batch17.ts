...
export const COOKING_EXPANSION_ANSWER_BATCH_17 = {
  ...
  { recipeId: "flour_egg_cacao_aged_cream", ingredientIds: ["farm:egg","farm:cacao","processed:cream"] },
  ...
  { recipeId: "special_seafood_soybean_broth_silverleaf_rice_sauce_fry", ingredientIds: ["fishing:catch_special","farm:soybean","processed:sauce","farm:silverleaf","farm:rice"] },
