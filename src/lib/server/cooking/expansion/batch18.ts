...
export const COOKING_EXPANSION_ANSWER_BATCH_18 = {
  ...
  { recipeId: "crystal_sugar_butter_white_strawberry_milk_pork_aged_cream", ingredientIds: ["farm:crystal_sugarcane","processed:butter","farm:white_strawberry","farm:milk","farm:pork"] },
