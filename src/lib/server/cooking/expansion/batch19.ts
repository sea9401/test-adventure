...
export const COOKING_EXPANSION_ANSWER_BATCH_19 = {
  ...
  { recipeId: "milk_strawberry_bread", ingredientIds: ["farm:milk","farm:strawberry"] },
  ...
  { recipeId: "fresh_fish_rice_tomato_sauce_fry", ingredientIds: ["fishing:catch_fresh","farm:rice","farm:tomato"] },
