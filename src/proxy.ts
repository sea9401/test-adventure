...
<main>
  <div class="box" role="status" aria-live="polite">
    ...
    <h1>서버 점검 안내</h1>
    <p class="lead">서버 안정화 작업을 위해 서버 점검을 진행합니다.</p>
    <dl class="details">
      <div class="row"><dt>점검 시간:</dt><dd>8월 26일(수) 오후 11:00 ~ 오후 11:30 (약 30분)</dd></div>
      <div class="row"><dt>점검 내용:</dt><dd>서버 안정화 작업</dd></div>
    </dl>
    <p class="notice">점검 중에는 게임 이용이 일시적으로 제한됩니다.<br />점검 진행 상황에 따라 종료 시각이 예정보다 앞당겨지거나 연장될 수 있습니다.</p>
    <p class="note">안정적인 서비스 제공을 위해 최선을 다하겠습니다.<br />감사합니다.</p>
  </div>
</main>
</body>
</html>`;
