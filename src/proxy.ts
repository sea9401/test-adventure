...
<title>오류 수정 패치 점검 안내 — 무슨무슨게임</title>
<style>
...
<main>
  <div class="box" role="status" aria-live="polite">
    <div class="status">패치 점검</div>
    <h1>오류 수정 패치 점검 안내</h1>
    <p class="lead">오류 수정 패치 적용을 위해 잠시 점검을 진행합니다.</p>
    <dl class="details">
      <div class="row"><dt>점검 시간:</dt><dd>08:30 ~ 08:45 (약 15분)</dd></div>
      <div class="row"><dt>점검 내용:</dt><dd>오류 수정 패치 적용</dd></div>
    </dl>
    <p class="notice">점검 중에는 게임 이용이 제한됩니다.<br />이용에 불편을 드려 죄송합니다.</p>
  </div>
</main>
</body>
</html>`;
