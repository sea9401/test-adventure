...
<main>
  <div class="box" role="status" aria-live="polite">
    ...
    <dl class="details">
      <div class="row"><dt>점검 시간:</dt><dd>8월 28일(금) 오전 4:00 ~ 오전 5:00 (약 1시간)</dd></div>
      <div class="row"><dt>점검 내용:</dt><dd>서버 안정화 및 시스템 점검</dd></div>
    </dl>
    <p class="notice">점검 중에는 서비스 이용이 제한될 수 있습니다.</p>
    <p class="note">이용에 불편을 드려 죄송하며, 더욱 안정적인 서비스를 제공할 수 있도록 최선을 다하겠습니다.<br />감사합니다.</p>
  </div>
</main>
</body>
</html>`;
