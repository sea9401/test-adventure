...
<title>8월 21일 서버 점검 30분 연장 안내 — 무슨무슨게임</title>
<style>
...
<main>
  <div class="box" role="status" aria-live="polite">
    <div class="status">점검 30분 연장</div>
    <h1>8월 21일 서버 점검 연장 안내</h1>
    <p class="lead">안녕하세요, 무슨무슨게임입니다.<br />안정적인 작업 마무리를 위해 점검 시간을 30분 연장합니다.</p>
    <dl class="details">
      <div class="row"><dt>점검 일시:</dt><dd>8월 21일(금) 오전 1시 ~ 오전 2시 30분</dd></div>
      <div class="row"><dt>점검 시간:</dt><dd>약 1시간 30분 (30분 연장)</dd></div>
      <div class="row"><dt>점검 내용:</dt><dd>전일 미완료 패치 외 업데이트, 서버 안정화</dd></div>
    </dl>
    <p class="notice">점검 중에는 게임에 접속할 수 없습니다.<br />이용에 불편을 드려 죄송합니다.</p>
    <p class="note">※ 작업 진행 상황에 따라 점검이 예정보다 일찍 종료될 수 있습니다.</p>
  </div>
</main>
</body>
</html>`;
