...
<title>8월 21일 서버 점검 안내 — 무슨무슨게임</title>
<style>
...
<main>
  <div class="box" role="status" aria-live="polite">
    ...
    <h1>8월 21일 서버 점검 안내</h1>
    <p class="lead">안녕하세요, 무슨무슨게임입니다.<br />원활한 서비스 제공을 위해 서버 점검을 진행합니다.</p>
    <dl class="details">
      <div class="row"><dt>점검 일시:</dt><dd>8월 21일(금) 오전 1시 ~ 오전 2시</dd></div>
      <div class="row"><dt>점검 시간:</dt><dd>약 1시간</dd></div>
