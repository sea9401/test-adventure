...
<title>8월 21일 서버 점검 1시간 연장 안내 — 무슨무슨게임</title>
<style>
...
<main>
  <div class="box" role="status" aria-live="polite">
    <div class="status">점검 1시간 연장</div>
    <h1>8월 21일 서버 점검 연장 안내</h1>
    <p class="lead">안녕하세요, 무슨무슨게임입니다.<br />안정적인 작업 마무리를 위해 점검 시간을 1시간 연장합니다.</p>
    <dl class="details">
      <div class="row"><dt>점검 일시:</dt><dd>8월 21일(금) 오전 1시 ~ 오전 3시</dd></div>
      <div class="row"><dt>점검 시간:</dt><dd>약 2시간 (1시간 연장)</dd></div>
